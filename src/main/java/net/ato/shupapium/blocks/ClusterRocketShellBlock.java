...
public class ClusterRocketShellBlock extends AbstractShupapiumBCBlock {
    public ClusterRocketShellBlock(Properties properties) {
        super(properties);
    }

    @Override
    public EntityType<? extends AbstractShupapiumBCProjectile> getAssociatedEntityType() {
        return ShupapiumEntities.CLUSTER_ROCKET_SHELL_PROJECTILE.get();
    }
}
