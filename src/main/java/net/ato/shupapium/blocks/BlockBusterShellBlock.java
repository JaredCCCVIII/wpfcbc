...
public class BlockBusterShellBlock extends AbstractShupapiumBCBlock{
    public BlockBusterShellBlock(Properties properties) {
        super(properties);
    }

    @Override
    public EntityType<? extends AbstractShupapiumBCProjectile> getAssociatedEntityType() {
        return ShupapiumEntities.BLOCK_BUSTER_SHELL_PROJECTILE.get();
    }
}
