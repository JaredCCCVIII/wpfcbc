...
public class ShupapiumBlockEntities {
    ...
    public static final BlockEntityEntry<ShupapiumACBreechBlockEntity> SHUPAPIUM_AUTOCANNON_BREECH = MainShupapium.REGISTRATE
            ...
            .validBlocks(ShupapiumBlocks.MACHINE_GUN_BREECH, ShupapiumBlocks.CANNON_GUN_BREECH, ShupapiumBlocks.BATTLE_GUN_BREECH, ShupapiumBlocks.ARTILLERY_GUN_BREECH, ShupapiumBlocks.ROCKET_POD_BREECH, ShupapiumBlocks.MORTAR_GUN_BREECH)
            .register();
