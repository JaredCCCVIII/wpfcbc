...
public class BattleHEGunAmmoEntity extends AbstractAutocannonProjectile implements ItemSupplier {
    ...
    static {
        PROJECTILE_ITEM = new ItemStack((ItemLike) CrustyChunksModItems.FLAK_SHELL.get());
    }
}
