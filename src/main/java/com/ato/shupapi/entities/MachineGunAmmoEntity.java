...
import net.mcreator.crustychunks.procedures.ArmorBypassHeavyGenericProcedure;
...
public class MachineGunAmmoEntity extends AbstractAutocannonProjectile implements ItemSupplier {
    ...
    public void onHitEntity(@NotNull EntityHitResult entityHitResult) {
        ...
        hitSomething = true;
        ArmorBypassHeavyGenericProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this);
    }
    ...
    static {
        PROJECTILE_ITEM = new ItemStack(CrustyChunksModItems.TINYPROJECTILE_ITEM.get());
    }
}
