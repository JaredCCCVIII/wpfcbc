...
public class BattleSolidGunAmmoEntity extends AbstractAutocannonProjectile implements ItemSupplier {
    ...
    public void onHitEntity(@NotNull EntityHitResult entityHitResult) {
        ...
        hitSomething = true;
        LargeSolidHitProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
    }
