...
public class BattleSolidGunAmmoEntity extends AbstractAutocannonProjectile {
    public BattleSolidGunAmmoEntity(EntityType<? extends AbstractAutocannonProjectile> type, Level level) {
        super(type, level);
    }
    ...
    public void onAddedToWorld() {
        ...
        if (!this.level().isClientSide()) {
            LargeSolidProjectileEntity shupapiumProjectile = new LargeSolidProjectileEntity(
                    CrustyChunksModEntities.LARGE_SOLID_PROJECTILE.get(),
                    this.level()
            );
