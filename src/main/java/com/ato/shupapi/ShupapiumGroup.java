    ...
    public static final Supplier<CreativeModeTab> GROUP = wrapGroup("shells", () -> {
        ...
        return createBuilder()
                ...
                .displayItems((pParameters, pOutput) -> {
                    ...
                    pOutput.accept(ShupapiumItems.MACHINE_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.LIGHT_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.ROTARY_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.HEAVY_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.BATTLE_HE_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.BATTLE_SOLID_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.BATTLE_HEAT_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.BATTLE_APFSDS_GUN_AMMO_ITEM);
                    pOutput.accept(ShupapiumItems.BATTLE_ARTILLERY_SOLID_GUN_AMMO_ITEM);
